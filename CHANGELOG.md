...
- `git submodule update --init` failing for FIGfonts when upstream advanced past the pinned commit (f8dcdd6)
...
[Unreleased]: https://github.com/nushell-prophet/nulet/compare/0.0.3...HEAD
[0.0.3]: https://github.com/nushell-prophet/nulet/compare/0.0.2...0.0.3
